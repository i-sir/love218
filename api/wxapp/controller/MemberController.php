...
class MemberController extends AuthController
{
     ...
     * 测试用
     *
     *   test_environment: http://love218.ikun:9090/api/wxapp/member/index
     *   official_environment: https://hl218.wxselling.com/api/wxapp/member/index
     ...
     * )
     *
     *   test_environment: http://love218.ikun:9090/api/wxapp/member/find_member
     *   official_environment: https://hl218.wxselling.com/api/wxapp/member/find_member
     ...
     * )
     *
     *   test_environment: http://love218.ikun:9090/api/wxapp/member/pass_login
     *   official_environment: https://hl218.wxselling.com/api/wxapp/member/pass_login
     ...
     * )
     *
     *   test_environment: http://love218.ikun:9090/api/wxapp/member/update_member
     *   official_environment: https://hl218.wxselling.com/api/wxapp/member/update_member
     ...
     * )
     *
     *   test_environment: http://love218.ikun:9090/api/wxapp/member/find_balance_list
     *   official_environment: https://hl218.wxselling.com/api/wxapp/member/find_balance_list
     ...
     * )
     *
     *   test_environment: http://love218.ikun:9090/api/wxapp/member/find_user
     *   official_environment: https://hl218.wxselling.com/api/wxapp/member/find_user
     ...
     * )
     *
     *   test_environment: http://love218.ikun:9090/api/wxapp/member/find_user_list
     *   official_environment: https://hl218.wxselling.com/api/wxapp/member/find_user_list
     ...
     * )
     *
     *   test_environment: http://love218.ikun:9090/api/wxapp/member/update_ranking
     *   official_environment: https://hl218.wxselling.com/api/wxapp/member/update_ranking
     ...
     * )
     *
     *   test_environment: http://love218.ikun:9090/api/wxapp/member/get_auth
     *   official_environment: https://hl218.wxselling.com/api/wxapp/member/get_auth
    ...
    public function get_auth()
    {
        ...
        if ($this->user_id && $this->user_info['identity_type'] == 'member' && $this->user_info['vip_id']) {
            ...
            if ($vip_info['pid']) {
                ...
                if ($vip_info['is_avatar'] == 1) $result['is_avatar'] = true;
                if ($vip_info['is_otherfile'] == 1) $result['is_otherfile'] = true;
                if ($vip_info['is_lovers'] == 1) $result['is_lovers'] = true;
                if ($vip_info['is_talk'] == 1) $result['is_talk'] = true;
                if ($vip_info['is_phone'] == 1) $result['is_phone'] = true;
                if ($vip_info['is_one'] == 1) $result['is_one'] = true;
            }
        }
